      ...
      <div>
        ...
        <div className="lg:mt-0 lg:flex-shrink-0">
          <div className="mt-12 inline-flex">
            <Link
              to={"/recipes"}
              className="py-4 px-8 bg-primaryDark hover:bg-accent text-secondary hover:text-primary transition ease-in duration-200 border-none text-center text-base font-semibold border shadow-lg shadow-secondary/20 focus:outline-none rounded-lg mb-5"
            >
              Recipe
            </Link>
          </div>
